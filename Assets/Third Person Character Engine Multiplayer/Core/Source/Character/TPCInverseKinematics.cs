...
namespace TPCEngine
{
	...
	public class TPCInverseKinematics
	{
		...
		public void Init(Animator animator)
		{
            ...
            transform = animator.transform.root.transform;
		...
		public virtual void FootIK()
		{
			...
			{
				Quaternion ikRotation = Quaternion.FromToRotation(transform.up, leftHit.normal) * transform.rotation;
			...
			{
				Quaternion ikRotation = Quaternion.FromToRotation(transform.up, rightHit.normal) * transform.rotation;
