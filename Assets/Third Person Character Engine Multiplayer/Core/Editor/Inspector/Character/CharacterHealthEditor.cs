    ...
    public class CharacterHealthEditor : TPCEditor
    {
        ...
        void OnEnable()
        {
            ...
            e_fallDamageParams = new ReorderableList(serializedObject, serializedObject.FindProperty("fallDamageParams"), true, true, true, true)
            {
                ...
                drawElementCallback = (rect, index, isActive, isFocused) =>
                {
                    ...
                    EditorGUI.LabelField(new Rect(rect.x, rect.y + 1, 55, EditorGUIUtility.singleLineHeight), "Damage");
                    ...
                    EditorGUI.LabelField(new Rect(rect.x + 110, rect.y + 1, 55, EditorGUIUtility.singleLineHeight), "Height");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (foldout_Health)
            {
                ...
                GUI.enabled = e_UseRegeniration.boolValue;
